...
#
# File: assign-users.directive.coffee
###

AssignUsersDirective = ($rootscope, $confirm, $repo, $modelTransform, $template, $compile,
$translate, $currentUserService) ->
    ...
    return {
        scope: true,
        templateUrl: "components/assign/assign-users.html",
        link: link,
        require: "ngModel"
    }
...
"tgCurrentUserService", AssignUsersDirective])
